            ...
            if soma_cartas > 21:
                ...
                if pontuacao[vez] < custo:
                    ...
                    if soma_cartas != 21:
                        ...
                        #while resposta != 'C' and resposta != 'P' and resposta != 'D':
...
QUE COMECEM OS JOGOS!!\n\n""")
    ...
    """
        dealer = Hand()
        soma_dealer = dealer.sum_total()
        baralho.move_cards(dealer, 1)
        print('\nCartas do dealer:\n')
        print(dealer)
        print('--------')
        b = dealer.sum_total()
        ...
        while soma_dealer < menor_soma:
            carta_dealer = baralho.move_cards(hands, 1)
            soma_dealer = dealer.sum_total()
        print('As cartas do dealer sao:\n')
        print(dealer)
        print('Soma: %d' % soma_dealer)
...
def opcaoEscolhida (mnu):
    ...
    print()
    return umTexto('Qual e a sua opcao? ', 'Opcao invalida', [str(opc) for opc in range(1,len(mnu)+1)])
"""